var Module = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    function findWasmBinary() {
      return locateFile('mazebuildercli.wasm')
    }
    ...
    function ___syscall_lstat64(path, buf) {
      if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(5, 0, 1, path, buf)
      try {
    ...
    function ___syscall_newfstatat(dirfd, path, buf, flags) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(6, 0, 1, dirfd, path, buf, flags)
      try {
        path = SYSCALLS.getStr(path)
    ...
    function ___syscall_openat(dirfd, path, flags, varargs) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(7, 0, 1, dirfd, path, flags, varargs)
      SYSCALLS.varargs = varargs
      try {
        path = SYSCALLS.getStr(path)
    ...
    var UTF16ToString = (ptr, maxBytesToRead, ignoreNul) => {
      ...
      if (endIdx - idx > 16 && UTF16Decoder)
        return UTF16Decoder.decode(
          HEAPU16.buffer instanceof ArrayBuffer
            ? HEAPU16.subarray(idx, endIdx)
    ...
    function assignWasmExports(wasmExports) {
      ...
      Module['_main'] = _main = wasmExports['X']
      ...
      __emscripten_run_js_on_main_thread = wasmExports['ca']
      __emscripten_thread_free_data = wasmExports['da']
      __emscripten_thread_exit = wasmExports['ea']
      __emscripten_check_mailbox = wasmExports['fa']
      ...
      dynCalls['ii'] = dynCall_ii = wasmExports['la']
      dynCalls['iii'] = dynCall_iii = wasmExports['ma']
      dynCalls['vii'] = dynCall_vii = wasmExports['na']
      dynCalls['v'] = dynCall_v = wasmExports['oa']
      dynCalls['i'] = dynCall_i = wasmExports['pa']
      dynCalls['viii'] = dynCall_viii = wasmExports['qa']
      dynCalls['iiii'] = dynCall_iiii = wasmExports['ra']
      dynCalls['viiii'] = dynCall_viiii = wasmExports['sa']
      dynCalls['iiiii'] = dynCall_iiiii = wasmExports['ta']
      dynCalls['viiiii'] = dynCall_viiiii = wasmExports['ua']
      dynCalls['viiiiii'] = dynCall_viiiiii = wasmExports['va']
      dynCalls['jiji'] = dynCall_jiji = wasmExports['wa']
      dynCalls['iidiiii'] = dynCall_iidiiii = wasmExports['xa']
      dynCalls['viijii'] = dynCall_viijii = wasmExports['ya']
      dynCalls['iiiiii'] = dynCall_iiiiii = wasmExports['za']
      dynCalls['iiiiiiiii'] = dynCall_iiiiiiiii = wasmExports['Aa']
      dynCalls['iiiiiii'] = dynCall_iiiiiii = wasmExports['Ba']
      dynCalls['iiiiij'] = dynCall_iiiiij = wasmExports['Ca']
      dynCalls['iiiiid'] = dynCall_iiiiid = wasmExports['Da']
      dynCalls['iiiiijj'] = dynCall_iiiiijj = wasmExports['Ea']
      dynCalls['iiiiiiii'] = dynCall_iiiiiiii = wasmExports['Fa']
      dynCalls['iiiiiijj'] = dynCall_iiiiiijj = wasmExports['Ga']
      _asyncify_start_unwind = wasmExports['Ha']
      _asyncify_stop_unwind = wasmExports['Ia']
      _asyncify_start_rewind = wasmExports['Ja']
      _asyncify_stop_rewind = wasmExports['Ka']
    }
    var wasmImports
