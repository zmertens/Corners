  ...
  return async function (moduleArg = {}) {
    ...
    async function createWasm() {
      function receiveInstance(instance, module) {
        ...
        registerTLSInit(wasmExports['aa'])
    ...
    function assignWasmExports(wasmExports) {
      ...
      _pthread_self = wasmExports['Z']
      _malloc = wasmExports['_']
      _free = wasmExports['$']
      __emscripten_tls_init = wasmExports['aa']
      __emscripten_thread_init = wasmExports['ba']
      __emscripten_thread_crashed = wasmExports['ca']
      __emscripten_run_js_on_main_thread = wasmExports['da']
      __emscripten_thread_free_data = wasmExports['ea']
      __emscripten_thread_exit = wasmExports['fa']
      __emscripten_check_mailbox = wasmExports['ga']
      _emscripten_stack_set_limits = wasmExports['ha']
      __emscripten_stack_restore = wasmExports['ia']
      __emscripten_stack_alloc = wasmExports['ja']
